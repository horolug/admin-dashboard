document.addEventListener(
  ...
  function () {
    ...
    marker1.bindPopup(
      '<b>Project #id-1</b><br> <a href="http://localhost:3000/project/device"> Device #id-1 info </a>',
    );

    var marker2 = L.marker([54.89, 23.9]).addTo(map);
    marker2.bindPopup(
      '<b>Project #id-1</b><br> <a href="http://localhost:3000/project/device"> Device #id-2 info </a>',
    );

    var marker3 = L.marker([54.884, 23.87]).addTo(map);
    marker3.bindPopup(
      '<b>Project #id-1</b><br> <a href="http://localhost:3000/project/device"> Device #id-3 info </a>',
    );
